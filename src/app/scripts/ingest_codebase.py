...
from src.app.configuration.dependencies import get_vector_db, get_code_classifier, get_graph_db_service

def main(paths):
    service = IngestionService(get_vector_db(), get_code_classifier(), get_graph_db_service())
